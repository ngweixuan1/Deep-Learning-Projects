...
class VanillaRNN(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size):
        ...
        #############################################################################
        self.hidden = nn.Linear(self.hidden_size+self.input_size, self.hidden_size)
        self.output = nn.Linear(self.hidden_size+self.input_size, self.output_size)
        self.tanh = nn.Tanh()
    ...
    def forward(self, input, hidden):
        ...
        output = self.softmax(self.output(concat))
